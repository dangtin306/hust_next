...
## Operational Example
A record with missing fields can stay in Pending Review. After structure, duplicate, and confidence checks pass, it can move into Processing and later reach the final result set.
