...
<span style={{ fontWeight: 700 }}>- Technical context:</span> This workflow includes signal ingestion, evidence verification, post-audit review, and risk indexing.

<span style={{ fontWeight: 700 }}>- Technical benefit:</span> It improves evidence quality, reduces repeated review work, and makes risk records easier to search, audit, and monitor.
...
<div style={{ marginTop: "0.75rem" }}>
  <img
    src="https://hust.media/img/tip_news/security-threat-detection_1.png"
    alt="Threat Signal Process"
    style={{ width: "87%", height: "auto", aspectRatio: "auto 16 / 9", display: "block", margin: "0 auto" }}
    loading="eager"
    decoding="sync"
    fetchPriority="high"
  />
